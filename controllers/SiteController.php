...
class SiteController extends Controller
{
    ...
    {
        return $this->render('index', ['file_exists' => \file_exists(Yii::$app->basePath.'/web/uploads/data.json')]);
    }
    ...
    {
        if(\file_exists(Yii::$app->basePath.'/web/uploads/data.json')){
            ...
            $data = new \app\models\JsonData();
            $provider = $data->search(Yii::$app->request->get());
            return $this->render('excel', ['provider' => $provider, 'filter'=>$data]);

        }
        else return $this->render('index', ['file_exists' => false]);
    }
